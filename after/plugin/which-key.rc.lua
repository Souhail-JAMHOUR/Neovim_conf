...
local function code_keymap()
    ...
    function CodeRunner()
        ...
        elseif ft == "python" then
            ...
            keymap_j = {
                name = "+Jupyter",
                i = { "<cmd>MagmaInit<Cr>", "MagmaInit" },
                d = { "<cmd>MagmaDeinit<Cr>", "MagmaDeinit" },
                e = { "<cmd>MagmaEvaluateLine<Cr>", "Evaluate Line" },
                r = { "<cmd>MagmaReevaluateCell<Cr>", "ReevaluateCell" },
                D = { "<cmd>MagmaDelete<Cr>", "Delete" },
                s = { "<cmd>MagmaShowOutput<Cr>", "ShowOutput" },
        ...
        if next(keymap_j_v) ~= nil then
            local k = { j = keymap_j_v }
            local o = { mode = "v", silent = true, noremap = true, buffer = bufnr, prefix = "<leader>", nowait = true }
            whichkey.register(k, o)
            legendary.bind_whichkey(k, o, false)
        end
